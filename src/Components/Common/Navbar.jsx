                        ...
                        user ?
                            <div className='flex'>
                                <div className='flex group relative'>
                                    ...
                                    <div className='p-2 px-4 absolute top-12 -left-4 z-20 bg-[#1a191f] border border-gray-700 text-xl font-semibold rounded opacity-0 group-hover:opacity-100'>{user.displayName}</div>
